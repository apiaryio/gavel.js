...
} = require('../../../lib/model/http-response');
const { sampleHttpResponseSchema } = require('../../fixtures');
...
describe('HttpResponse', () => {
  ...
  describe('when I create new instance', () => {
    before(() => {
      expectedHttpResponse = new ExpectedHttpResponse({
        statusCode: '1',
        statusMessage: '2',
        headers: '3',
        body: '4',
    ...
    it('should has correct structure', () => {
      assert.isUndefined(
        validate(
          JSON.parse(JSON.stringify(httpResponse)),
