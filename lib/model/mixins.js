...
validatable = {
  ...
  validateBody: function() {
    if (typeof this.validateBodyResult === 'undefined') {
      this.validateBodyResult = this.getValidator('body').validate();
    }
    return this.validateBodyResult;
  },
  validateHeaders: function() {
    if (typeof this.validateHeadersResult === 'undefined') {
      this.validateHeadersResult = this.getValidator('headers').validate();
    }
    return this.validateHeadersResult;
  },
  validateStatus: function() {
    var _ref;
    if (typeof this.validateStatusCodeResult === 'undefined') {
      if (!this.statusCode) {
        this.validateStatusCodeResult = true;
      } else {
        this.validateStatusCodeResult = this.statusCode === ((_ref = this.expected) != null ? _ref.statusCode : void 0);
      }
    }
    return this.validateStatusCodeResult;
  },
